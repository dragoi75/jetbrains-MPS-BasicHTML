...
/*package*/ class BodyTag_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BodyTag_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_9pj3bu_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_9pj3bu_a0");
    Style style = new StyleImpl();
  ...
  private EditorCell createCollection_1() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_9pj3bu_b0");
    editorCell.addEditorCell(createRefNode_0());
    return editorCell;
  }
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new bodySingleRoleHandler_9pj3bu_a1a(myNode, LINKS.body$mNB6, getEditorContext());
    return provider.createCell();
  }
  private static class bodySingleRoleHandler_9pj3bu_a1a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public bodySingleRoleHandler_9pj3bu_a1a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "</body>");
    editorCell.setCellId("Constant_9pj3bu_c0");
    Style style = new StyleImpl();
