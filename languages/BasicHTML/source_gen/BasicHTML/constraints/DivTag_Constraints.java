...
public class DivTag_Constraints extends BaseConstraintsDescriptor {
  public DivTag_Constraints() {
    super(CONCEPTS.DivTag$wL);
  }
  ...
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:0dedb409-9188-4cc0-baae-7905264d5193(BasicHTML.constraints)", "9118809814081400573");
